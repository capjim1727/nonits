			...
			<body>
				<div class="container">
                    <div role="main" class="main">
						...
						<h1 class="text-5 text-center">Appointments</h1>
							...
							<br>
								<table border="2">
									...
									$sql = "SELECT FirstName, LastName, Phone, Email, Date, Time, created_at FROM appointments";
									$result = $connection->query($sql);

									if ($result->num_rows > 0) {
										// output data of each row
										while($row = $result->fetch_assoc()) {
											echo "<tr><td>". $row["FirstName"]. "</td><td>" . $row["LastName"] . "</td><td>". $row["Phone"]. "</td><td>" . $row["Email"] . "</td><td>". $row["Date"]. "</td><td>" . $row["Time"] . "</td><td>" . $row["created_at"] . "</td></tr>";
										}
									} else {
										echo "0 results";
									}
