...
<html>
  ...
  <script src="https://www.paypal.com/sdk/js?client-id=AUqtGkrHRP76YxqGEgA4irIQ5bsb6HAWg2jJ78NX5k4tqA58frBYj-aznksfGSHGrXBbtZ0MYlMEey78&enable-funding=venmo&currency=USD" data-sdk-integration-source="button-factory"></script>
  <script>
      ...
      paypal.Buttons({
        ...
        createOrder: function(data, actions) {
          return actions.order.create({
            purchase_units: [{"description":"Deposit","amount":{"currency_code":"USD","value":150}}]
          });
        },
