				...
				<div class="container"> 
					<div role="main" class="main">
                        <div class="row py-4 my-5">
							<h1 class="text-5 text-center">Customers</h1>
								...
								<table border="2">
									...
									if ($result->num_rows > 0) {
										...
										while($row = $result->fetch_assoc()) {
											echo "<tr><td>". $row["CustomerID"]. "</td><td>". $row["FirstName"]. "</td><td>" . $row["LastName"] . "</td><td>". $row["Phone"]. "</td><td>" . $row["Email"] . 
											"</td><td>". $row["Gender"]. "</td><td>" . $row["Age"] . "</td><td>". $row["Note"]. "</td><td>". $row["created_at"] . "</td></tr>";
										}
									} else {
										echo "0 results";
									}
