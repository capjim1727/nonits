...
if(isset($_POST['button'])){   
    ...
    $dup=mysqli_query($connection,"SELECT * FROM appointments where Time='$Time' and Date='$Date'");
    $checkrows=mysqli_num_rows($dup);
    if($checkrows>0)
    {
        echo "<script>alert('Please Select a Different Date or Time')</script>";
    } 
    else
    {
        
     //TO INSERT customer information from field to nonits database customer table
    $query = "INSERT INTO appointments(FirstName,LastName,Phone,Email,Date,Time) VALUES('$FirstName', '$LastName', '$Phone', '$Email', '$Date', '$Time')";  
    ...
    {
        header("Location: checkout.php"); //will redirect after 3 seconds 
    }
}
}
?>
                ...
                <header id="header" class="header-effect-shrink" data-plugin-options="{'stickyEnabled': true, 'stickyEffect': 'shrink', 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyChangeLogo': true, 'stickyStartAt': 120, 'stickyHeaderContainerHeight': 70}">
                    ...
                    <section class="insurance-providers pt-6 pb-lg-5 bg-color-grey">
                        <div class="container my-lg-3 py-lg-2">
                            <div class="row">
                                <div class="col">
                                    <p class="text-uppercase mb-0 d-block text-center text-uppercase appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300"></p>
                                    <h3 class="text-color-quaternary mb-2 d-block text-center font-weight-bolder text-capitalize appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Payment Options</h3>
                                    <p class="mb-5 d-block text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500"></p>
                                </div>
                            </div>
                            <div class="row align-items-center justify-content-center">
                                <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-flex align-items-center justify-content-center mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="100">
                                    <a href="checkout.php"><img class="img-fluid" src="img/visa.jpg" alt="Visa"></a>
                                </div>
                                <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-flex align-items-center justify-content-center mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
                                    <a href="checkout.php"><img class="img-fluid" src="img/mastercard.png" alt="Mastercard"></a>
                                </div>
                                <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-flex align-items-center justify-content-center mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
                                    <a href="checkout.php"><img class="img-fluid" src="img/americanexpress.jpg" alt="AmericanExpress"></a>
                                </div>
                                <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-flex align-items-center justify-content-center mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">
                                    <a href="checkout.php"><img class="img-fluid" src="img/venmo.jpg" alt="Venmo"></a>
                                </div>
                                <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-flex align-items-center justify-content-center mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">
                                    <a href="checkout.php"><img class="img-fluid" src="img/paypal.jpg" alt="Paypal"></a>
                                </div>
                            </div>
                        </div>
				    </section> 
